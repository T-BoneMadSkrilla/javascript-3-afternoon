...
//Code Here
let postTaxPrices = prices.map((element, index, wholeArray) => {return element *= 1.07} )
...
//change
//Code Here
var myStrongest = monstersInYourPocket.filter(function(monsters){ if (monsters.CP >200){return monsters}}); // = monstersInYourPocket.filter(/* Provide Your Callback Here */)
...
let orderTotals = orders.map(function(x, price, tax){x = price * tax; return x}) // Code here
